...
PLAN P WHERE P.PROC_DT_TM > CNVTDATETIME("01-OCT-2025 00:00:00")
AND P.PROC_DT_TM < CNVTDATETIME("31-OCT-2025 23:59:59")
...
AND E.ORGANIZATION_ID = 2170807 ;Limerick Hospital
...
AND PA.ALIAS_POOL_CD = 197542759 ;Limerick MRN
